...
var discon = {
    ...
    introAll: function () {
        showSlide("introAll");
        document.getElementById("text_introAll").innerHTML = "In diesem Spiel nehmen Dich die Tiere mit zu sich nach Hause. Jedes der Tiere wohnt in einem Haus und jedes hat viele verschiedene Dinge zu hause. Jedes Tier erz&auml;hlt Dir von den Dingen die es zu Hasue hat.";
        document.getElementById("text_introAll_2").innerHTML = "Deine Aufgabe ist es, das Ding zu ber&uuml;hren, &uuml;ber das das Tier spricht. Pass also gut auf und finde heraus welches Du ber&uuml;hren musst.";
    },
